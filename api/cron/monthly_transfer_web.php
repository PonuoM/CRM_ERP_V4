...
foreach ($companies as $companyId) {
    ...
    foreach ($configs as $config) {
        ...
        $useDynamicRetention = ($extendDaysPerAppt > 0 || ($salesThreshold > 0 && $salesRewardDays > 0));
                ...
                SELECT c.customer_id, c.first_name, c.last_name, c.assigned_to,
                       ...
                       COALESCE((
                           ...
                           WHERE o.customer_id = c.customer_id
                             ...
                             AND o.order_date >= DATE_SUB(c.basket_entered_date, INTERVAL 40 DAY)
        ...
        foreach ($customers as $customer) {
            ...
            if ($dryRun) {
                ...
                try {
                    ...
                    if ($keepAssignedTo) {
                        // ถังปลายทางเป็น Dashboard → เก็บ assigned_to ไว้
