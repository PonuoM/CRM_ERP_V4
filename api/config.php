...
// NOTE: keep this identical to the copy in the root config.php (see user_has_permission's note: in
// production host-build deploys the root config.php in place of this file).
if (!defined('HR_DB')) {
