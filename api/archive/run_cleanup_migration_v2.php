...
function columnExists(PDO $pdo, string $table, string $column): bool {
    try {
        // Use DESCRIBE instead of SHOW COLUMNS with bind, as some MySQL versions fail with bind in SHOW
...
try {
    $pdo = db_connect();
    echo "Starting intelligent cleanup migration (v2)...\n";
    ...
    echo "customer_tags.customer_id type: $type\n";
    ...
    if (strpos($type, 'varchar') !== false) {
        ...
        echo "customer_tags already cleaned.\n";
    }
