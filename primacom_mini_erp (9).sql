...
--
-- Host: localhost
-- Generation Time: Feb 01, 2026 at 03:13 PM
...
--
-- Table structure for table `customer_last_change_logs`
--

CREATE TABLE `customer_last_change_logs` (
  `customer_id` varchar(32) NOT NULL,
  `target_assigned_to` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
