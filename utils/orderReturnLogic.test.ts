...
describe('checkReturnStatusChange', () => {
  it('should return PROMPT_NEW_STATUS when order is Returned and one box is changed to null (ยกเลิกตีกลับ / จัดส่งสำเร็จ)', () => {
  ...
  it('should return PROMPT_NEW_STATUS when order is Returned and all boxes are changed to null (ยกเลิกตีกลับ / จัดส่งสำเร็จ)', () => {
