...
| `pages/CancellationPage.tsx` | หน้ารวม "ตรวจสอบคำสั่งซื้อ" — 4 tab: จัดประเภทยกเลิก + ตรวจสอบโปรโมชั่น + ตั้งค่ายกเลิก + สั่งทำ |
...
### Flow 3: จัดประเภท bulk (CancellationPage → Tab "จัดประเภทยกเลิก")
...
### Flow 4: ตั้งค่าประเภทยกเลิก (CancellationPage → Tab "ตั้งค่ายกเลิก")
