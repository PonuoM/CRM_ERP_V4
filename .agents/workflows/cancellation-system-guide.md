...
| `pages/CancellationPage.tsx` | หน้ารวม "ตรวจสอบคำสั่งซื้อ" — 2 tab: จัดประเภท (bulk classification) + ตั้งค่า (CRUD ประเภท + default) |
...
### Flow 3: จัดประเภท bulk (CancellationPage → Tab "จัดประเภท")
...
### Flow 4: ตั้งค่าประเภทยกเลิก (CancellationPage → Tab "ตั้งค่า")
...
3. ตั้งค่าประเภทเริ่มต้นผ่านหน้า "ตรวจสอบคำสั่งซื้อ" → Tab "ตั้งค่า"
