...
4. **Frontend (`pages/InventoryPage.tsx` & `pages/CompanySettingsPage.tsx`)**
   ...
   - **แท็บรวมทุกคลัง (Group by SKU):** ฟีเจอร์ใหม่ที่ช่วยจับกลุ่มข้อมูลสินค้าเดียวกันที่กระจายอยู่หลายคลัง ให้เหลือ 1 แถวต่อ 1 SKU (รวมจำนวน qty, available, lock ฯลฯ) เมื่อกดคลิกขยายแถว จะแสดงเป็นตารางย่อยเพื่อแจกแจงสถิติแยกตามคลังสินค้าแทนการแสดงกราฟ
