...
| `api/Commission/get_stamp_batches.php` | GET — ดึง batch ทั้งหมด / drill-down ดู orders |
...
| `api/Commission/export_commission_orders.php` | GET — Export CSV + คอลัมน์ค่าคอม |
...
| `components/Sidebar.tsx` | เมนู "Stamp ค่าคอม" ใน section การเงิน |
