...
**คอลัมน์ CSV:**
`วันที่สั่งซื้อ, เวลาที่สั่งซื้อ, เลขคำสั่งซื้อ, user_id, ผู้ขาย, แผนก, ชื่อลูกค้า, เบอร์โทรลูกค้า, ประเภทลูกค้า, วันที่จัดส่ง, ช่องทางสั่งซื้อ, เพจ, ช่องทางการชำระ, ที่อยู่, ตำบล, อำเภอ, จังหวัด, รหัสไปรษณีย์, ภาค, รหัสสินค้า/โปร, สินค้า, ประเภทสินค้า, ประเภทสินค้า (รีพอร์ต), ชื่อโปร, ของแถม, จำนวน (ชิ้น), ราคาต่อหน่วย, ส่วนลด, ยอดรวมรายการ, ค่าจัดส่ง (ต่อบิล), ส่วนลดท้ายบิล, ยอดรวมทั้งบิล, ยอดรวมรายคน, หมายเลขกล่อง, หมายเลขติดตาม, วันที่จัดส่ง Airport, สถานะจาก Airport, สถานะออเดอร์, สถานะการชำระเงิน, สถานะสลิป, วันที่รับเงิน, ตะกร้าขาย, สาเหตุยอดไม่ตรง`
