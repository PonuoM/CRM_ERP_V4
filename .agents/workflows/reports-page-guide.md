...
- **ยอดรวมรายการ**: ค่าจาก `order_items.net_total` ตรงๆ ไม่คำนวณใหม่
...
- **ยอดรวมทั้งบิล (Total Bill)**: แสดงยอดรวมทั้งหมดของออเดอร์นั้นเฉพาะในบรรทัดแรกสุดของออเดอร์ ส่วนบรรทัดถัดไปจะแสดงเป็น `-`
- **ยอดรวมรายคน**: คำนวณยอดขายรวมของแต่ละคน (Sum by Creator) โดยจะแสดงยอดรวมเฉพาะในบรรทัดแรกของสินค้าที่ผู้ขายคนนั้นๆ ขายได้ในออเดอร์นั้น ส่วนบรรทัดถัดไปของผู้ขายคนเดิมจะแสดงเป็น `-` (หมายเหตุ: หากบิลนั้นมีค่าจัดส่งหรือส่วนลดท้ายบิล ระบบจะทำการหารเฉลี่ยและกระจายสัดส่วนตามมูลค่าสินค้าที่แต่ละคนขายได้ - Proportional Distribution)
