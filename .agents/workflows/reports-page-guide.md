...
- **ยอดรวมทั้งบิล (Total Bill)**: คำนวณแบบแยกตามผู้ขาย (Sum by Creator) โดยจะแสดงยอดรวมเฉพาะในบรรทัดแรกของสินค้าที่ผู้ขายรายนั้นขายได้ในออเดอร์นั้น ส่วนบรรทัดถัดไปของผู้ขายคนเดิมจะแสดงเป็น `-`
...
- **โครงสร้างคอลัมน์**: อ้างอิงตาม `orders-raw` ทั้งหมด (รวมถึง `ค่าจัดส่ง (ต่อบิล)`, `ส่วนลดท้ายบิล`, และ `ยอดรวมทั้งบิล` ที่แยก sum ตามผู้ขาย) แต่จะต่อท้ายด้วยคอลัมน์สถานะค่าคอมและข้อมูลการ Stamp
