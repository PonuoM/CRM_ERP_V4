...
- **ค้นหา**: รองรับการค้นหาด้วย 
    - **Order ID**: ค้นหาด้วยเลข Order ID โดยตรง (รวมถึง ID ย่อ เช่น "038")
    - **ชื่อลูกค้า**: ค้นหาบาร์ชื่อและนามสกุล
    - **เบอร์โทรศัพท์**: รองรับการค้นหาด้วยเบอร์โทรบางส่วน และไม่สนใจขีดหรือเว้นวรรค (เช่น พิมพ์ "081234" เจอ "081-234-xxxx")
