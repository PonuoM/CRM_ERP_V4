...
- พนักงานสามารถค้นหาโปรไฟล์ของลูกค้าสองคนขึ้นมาเทียบกันได้จากในหน้าจอ Modal
- เมื่อเลือกได้ว่าให้ตารางใดเป็น **ข้อมูลหลัก (Main Record)** 
- ประวัติการโทร (`call_history`) และบิลคำสั่งซื้อ (`orders`) ของอีกเบอร์จะถูกโอนไปให้ **ข้อมูลหลัก** ทั้งหมด
- ระบบจงใจไม่ลบเบอร์สำรองทิ้ง (แต่บิลและประวัติจะหายไปอยู่กับเบอร์หลักแทน) เพื่อให้ยังใช้สืบประวัติย้อนหลังในระดับ Basic ได้
