...
## 5. ระบบโอนรายชื่อ (Transfer System) [NEW: Flexible Transfer]

ฟีเจอร์สำหรับโอนรายชื่อลูกค้าจากพนักงานคนหนึ่งไปยังพนักงานอีกคน ระบบใหม่รองรับการทำงาน 3 รูปแบบ:

### วิธีใช้งาน 1: Quick Transfer (1-to-1) [แบบเดิม]
1. กดปุ่ม **"ดึงคืน"** ในแถวของพนักงานต้นทาง
2. ในแต่ละถัง จะมีปุ่ม **"โอน"** สีฟ้า (ข้างปุ่ม "คืนหมด")
3. กดปุ่ม "โอน" → **Transfer Modal (เดิม)** จะเปิดขึ้นมาโอนได้ทีละถังไปหาทีละคน

### วิธีใช้งาน 2: Flexible Transfer (แบบใหม่ยืนหยุ่น)
1. กดที่ปุ่ม **"โอนรายชื่อ"** แทบเมนูด้านบนขวาถัดจากปุ่ม "Manual Reset"
2. เลือกระบบการโอน 2 รูปแบบ
   - **1 คน → โอนให้หลายคน**: เลือกพนักงานต้นทางและถังงาน จากนั้น
     - (1) **ใส่ยอดรวม** ที่ต้องการดึงจากถังนี้
     - (2) **ติ๊กเลือกพนักงานปลายทาง** ด้วย Checkbox
     - (3) กดปุ่ม **"เฉลี่ยให้คนที่เลือก"** ระบบจะหารเฉลี่ยจำนวนลูกค้าส่งให้ปลายทางทุกคนเท่าๆ กันทันที หรือสามารถพิมพ์ปรับกรอกจำนวนเองรายบุคคลได้
   - **หลายคน → โอนรวมให้ 1 คน**: เลือกปลายทาง 1 คน จากนั้นระบุจำนวนที่ต้องการดึงจากต้นทางหลายๆ คนในหน้าต่างเดียว
3. กด **"ยืนยันโอนรายชื่อ"**
