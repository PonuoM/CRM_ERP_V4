-- ============================================
-- SQL Script: Update Customer Statistics (Batch Mode - Fixed)
-- ============================================

-- ส่วนที่ 1: ลบ Procedure เก่าทิ้งก่อน (ถ้ามีค้างอยู่)
DROP PROCEDURE IF EXISTS UpdateCustomerStatsBatch;

-- ส่วนที่ 2: สร้างและรัน Procedure
DELIMITER $$

CREATE PROCEDURE UpdateCustomerStatsBatch()
BEGIN
    DECLARE done INT DEFAULT FALSE;
    DECLARE batch_size INT DEFAULT 500; -- ลดขนาด batch ลงอีกเพื่อให้เร็วขึ้นและลด lock
