...
const OrderManagementModal: React.FC<OrderManagementModalProps> = ({ order, customers, activities, onSave, onClose, currentUser }) => {
  ...
  const handleAmountPaidChange = (amount: number) => {
    ...
    if (newAmount === 0) {
      ...
      newPaymentStatus = PaymentStatus.Paid; // paid or overpaid
    }
    setCurrentOrder(prev => ({
      ...prev,
                        ...
                        <div>
                            ...
                            <div className="flex items-center space-x-2">
                                <label 
                                    ...
                                    className={`cursor-pointer w-full text-center py-2 px-4 bg-white border border-gray-300 rounded-lg text-gray-600 flex items-center justify-center ${
                                        currentOrder.paymentStatus === PaymentStatus.Paid 
