              ...
              return (
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <button data-testid={`btn-manage-order-${order.id}`} onClick={() => openModal('manageOrder', isWaitingVerifySlipTab ? { ...order, isWaitingVerifySlipTab: true } as any : order)} className="font-medium text-blue-600 hover:underline">จัดการ</button>
