...
import { X, DollarSign, FileText, AlertCircle, Clock, CheckCircle2, XCircle, AlertTriangle } from 'lucide-react';
import { createDebtCollection, getDebtCollectionHistory, DebtCollectionRecord } from '../services/api';
...
const DebtCollectionModal: React.FC<DebtCollectionModalProps> = ({
    ...
    return (
        <Modal onClose={handleClose} title="บันทึกการติดตามหนี้" size="xl">
            <div className="flex flex-col md:flex-row gap-6">
                                ...
                                <label className="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                                    <input
                                        ...
                                        onChange={() => {
                                            ...
                                            // setCloseCase(true); // Removed auto-check as per request
                                        }}
                                        className="mr-3"
                                    />
                                    <div>
                ...
                {/* Right Side: History */}
                <div className="md:w-80 border-l pl-0 md:pl-6 pt-6 md:pt-0 border-t md:border-t-0">
