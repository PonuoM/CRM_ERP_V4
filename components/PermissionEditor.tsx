...
const PERMISSION_GROUPS_DEF = {
    ...
    'Home': {
        ...
        items: [
            ...
            { key: 'home.sales_sheet', label: 'Sales Sheet (ยอดขาย Sheet)' },
    ...
    'Orders & Customers': {
        ...
        items: [
            ...
            { key: 'nav.pending_orders', label: 'เมนู ออเดอร์รอเปิด' },
            { key: 'orders.proxy_sale', label: 'ขายแทน (ลงออเดอร์แทน Telesale คนอื่น)' },
            { key: 'customers.transfer_owner', label: 'เปลี่ยนผู้ดูแลลูกค้า + อนุมัติคำขอโอน' },
            { key: 'nav.transfer_requests', label: 'เมนู คำขอโอนลูกค้า (ดูสถานะ/ยื่นคำขอ)' },
            { key: 'settings.transfer_policy', label: 'เมนู การอนุมัติโอนย้ายลูกค้า (เปิดปิดรายบริษัท)' },
    ...
    'Call Management': {
        ...
        items: [
            ...
            { key: 'calls.overview_v2', label: 'Calls Overview V2 (ภาพรวมการโทร V2)' },
            { key: 'calls.details_v2', label: 'Call Details V2 (รายละเอียดการโทร V2)' },
